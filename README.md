...
- **NOTE**: For ***Sora FC, SC, and the 3rd***, you also need copy `data/bgm/arrange/ed6501.at9` into `at9`. Keep also in mind that to each game goes its ed6501 file, as the lyrics differ in each game.
